...
import { Field, Input, Btn, toast } from '../components/UI.jsx'
...
export default function Settings() {
  ...
  const [profileForm, setProfileForm] = useState({
    ...
    phone: '', title: 'Senior Attorney', firmName: 'LawLibra Legal Partners', bio: '',
  })
  ...
  // Profile save is UI-only for now (no dedicated PATCH /users/me endpoint yet)
  const saveProfile = () => {
            ...
            <div className="space-y-5">
              <div className="bg-surface-container-lowest rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex justify-end pt-2">
                    <Btn variant="primary" onClick={changePw} disabled={pwLoading}>
              ...
              <div className="bg-surface-container-lowest rounded-xl shadow-sm overflow-hidden border border-red-100">
                ...
                <div className="p-6 flex items-center justify-between">
                  ...
                  <button onClick={() => toast.warning('Account deletion requires Admin approval.')}
